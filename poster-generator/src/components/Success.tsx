...
const Success: React.FC<SuccessProps> = ({ userData, onReset }) => {
        ...
        const generate = async () => {
            ...
            if (hiddenPosterRef.current && window.html2canvas) {
                try {
                    ...
                    const f = new File([blob], `Donation-Certificate-${userData.fullName.replace(/\s+/g, '-')}.png`, { type: 'image/png' });
                    setFile(f);
                } catch (e) {
    ...
    const handleDownload = () => {
        ...
        a.href = imageUrl;
        a.download = `Donation-Certificate-${userData.fullName.replace(/\s+/g, '-')}.png`;
        ...
        if (file && navigator.share && navigator.canShare({ files: [file] })) {
            try {
                await navigator.share({
                    ...
                    text: `I'm proud to support the Watch Donation Drive! Join me in gifting a future.`
                });
            } catch (err) {
    ...
    const handleDonate = () => {
        const msg = encodeURIComponent("Hi, I'd like to donate a watch.");
        window.open(`https://wa.me/919940142349?text=${msg}`, '_blank');
    };
        ...
        <section className="min-h-screen py-12 px-4 flex flex-col items-center animate-fade-in text-center">
            ...
            <div className="max-w-xl w-full">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-400">Your specific contribution has been honored.</p>
                </div>
                ...
                <div className="border-t border-white/10 pt-8 mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-left">
                        <h3 className="font-bold text-lg mb-1">Inspired to Give?</h3>
                        <p className="text-gray-400 text-sm mb-3">Donate your watch today.</p>
