    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center pt-32 px-16 text-center h-full">
                ...
                {/* Title */}
                <div className="mb-12">
                    <span className="block text-amber-500 tracking-[0.3em] text-xl font-sans mb-4 uppercase">Officially Presented To</span>
                ...
                <div className="mt-auto mb-24 flex items-center justify-between w-full px-12 border-t border-white/10 pt-8">
                    ...
                    <div className="text-right">
                        <p className="text-amber-500 text-lg font-bold font-sans">GENERIC POSTER APP</p>
